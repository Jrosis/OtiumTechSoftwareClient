...
Public Class CrpClienteAvancado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OtiumTechCliente.CrpClienteAvancado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpClienteAvancado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpClienteAvancado = New CrpClienteAvancado()
        rpt.Site = Me.Site
        Return rpt
    End Function
