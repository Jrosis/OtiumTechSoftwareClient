...
Public Class CrpDespesaAvancado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OtiumTechCliente.CrpDespesaAvancado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpDespesaAvancado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpDespesaAvancado = New CrpDespesaAvancado()
        rpt.Site = Me.Site
        Return rpt
    End Function
